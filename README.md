...
![Conda](https://img.shields.io/conda/dn/bioconda/metasbt?label=downloads)
...
> [!WARNING]  
> This branch is under active development. Features may be unstable, and the codebase is subject to frequent, breaking changes.
...
Copyright © 2026 [Fabio Cumbo](https://github.com/cumbof), [Daniel Blankenberg](https://github.com/blankenberg). See [LICENSE](https://github.com/cumbof/MetaSBT/blob/main/LICENSE) for additional details.
